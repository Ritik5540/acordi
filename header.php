...
<head>
    ...
    <meta charset="utf-8">
    <title>Welcome to Agricultural Consultancy and Rural Development Institute</title>
...
<body>
    ...
    <!-- Topbar Start -->
    <div class="container-fluid bg-secondary top-bar">
            ...
            <nav class="navbar navbar-expand-lg bg-primary navbar-dark px-4 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav me-auto">
                        ...
                        <div class="nav-item dropdown">
                            <a href="javascript:void(0)" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Messages</a>
                            <div class="dropdown-menu bg-light m-0">
                                <a href="general_secretary.php" class="dropdown-item">Message from the General Secretary</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            <a href="javascript:void(0)" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Certificates</a>
                            <div class="dropdown-menu bg-light m-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="javascript:void(0)" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Media</a>
                            <div class="dropdown-menu bg-light m-0">
                    ...
                    <div class="d-none d-lg-flex ms-auto">
                        <a class="btn btn-square btn-dark ms-2" href="javascript:void(0)"><i class="fab fa-twitter"></i></a>
                        <a class="btn btn-square btn-dark ms-2" href="javascript:void(0)"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-square btn-dark ms-2" href="javascript:void(0)"><i class="fab fa-youtube"></i></a>
                    </div>
                </div>
            </nav>
        </div>
