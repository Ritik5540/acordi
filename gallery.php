...
<div class="container-fluid position-relative text-white d-flex align-items-center justify-content-center"
    ...
    <div class="position-relative text-center">
        <ol class="breadcrumb justify-content-center mb-0">
            <h1 class="display-4 fw-bold text-white mb-2">Program Gallery</h1>
        </ol>
    </div>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <?php
        $sql = "SELECT * FROM galleries WHERE gallery_type = 'program' ORDER BY created_at ASC";
            ...
            <div class="modal-body p-0">
                ...
                <div id="galleryCarousel" class="carousel slide" data-bs-ride="false">
                    <div class="carousel-inner">ss
                        ...
                        <?php
                        $sql = "SELECT * FROM galleries WHERE gallery_type = 'program' ORDER BY created_at DESC";
                        $result = $conn->query($sql);
                        while ($row = $result->fetch_assoc()):
                        ?>
